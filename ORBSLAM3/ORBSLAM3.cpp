...
int main(int argc, char *argv[])
{
	...
	for (int seq = 0; seq < num_seq; seq++)
	{
		...
		string pathSeq("H:/DATA/V102");
		string pathTimeStamps("Examples/Monocular-Inertial/EuRoC_TimeStamps/V102.txt");
	...
	ORB_SLAM3::System SLAM(string("Vocabulary/orbvoc.dbow3"), string("Examples/Monocular-Inertial/EuRoC.yaml"), ORB_SLAM3::System::IMU_MONOCULAR, true);
